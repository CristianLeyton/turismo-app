...
{{--     <p class="text-sm text-gray-700 dark:text-gray-300 mb-3">
    ...
    <button type="button" wire:click="searchTrip" wire:loading.attr="disabled" wire:target="searchTrip"
        ...
        <svg wire:loading.remove wire:target="searchTrip" class="fi-icon-btn-icon w-4 h-4" fill="none"
            stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
        </svg>
        <svg wire:loading wire:target="searchTrip" class="fi-icon-btn-icon w-4 h-4 animate-spin" fill="none"
            viewBox="0 0 24 24">
        ...
        <span wire:loading.remove wire:target="searchTrip">Buscar viaje de ida</span>
        <span wire:loading wire:target="searchTrip">Buscando viaje de ida...</span>
    </button>
</div>
