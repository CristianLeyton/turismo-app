            ...
            <div class="overflow-x-scroll max-w-[83dvw] sm:max-w-[90dvw] md:max-w-full md:overflow-x-auto">
                <table class="min-w-full">
                    <thead class="bg-gray-50 dark:bg-gray-800">
                        <tr>
                            <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Boleto N°</th>
                        ...
                        @foreach ($passengers as $passenger)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                <td class="px-4 py-2 text-sm text-center">
                                    <span class="inline-block px-2 py-1 text-xs bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 rounded-lg">
                                        {{ $passenger['ticket_id'] }}
                                    </span>
                                </td>
