        ...
        return $this->tickets()
            ...
            ->map(function ($ticket) {
                return [
                    ...
                    'departure_time' => ($ticket->getBoardingDepartureTime($this) ?? $this->departure_time)?->format('H:i') ?? 'N/A',
                    'arrival_time' => ($ticket->getBoardingArrivalTime($this) ?? $this->arrival_time)?->format('H:i') ?? 'N/A',
                    'bus_name' => $this->bus?->name ?? 'N/A',
                    'price' => $ticket->price,
